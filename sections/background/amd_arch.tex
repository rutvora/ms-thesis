\subsection{AMD CPU Architecture}
...
We provide a simplified view of the pipeline in the CPU cores of the AMD EPYC Zen 3 processors in \Cref{fig:amd-core} and brief description of each of the stages:\\
