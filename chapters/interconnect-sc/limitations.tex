...
First, to carry out a side-channel attack using \textit{store} operations (as outlined in \Cref{sec:interconnect-sc-store-ops}), the attacker requires superuser privileges.
